...
/// Adds pattern-matching-related methods to [ComicCarouselItem].
extension ComicCarouselItemPatterns on ComicCarouselItem {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ComicCarouselItem value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ComicCarouselItem() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ComicCarouselItem value)  $default,){
final _that = this;
switch (_that) {
case _ComicCarouselItem():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ComicCarouselItem value)?  $default,){
final _that = this;
switch (_that) {
case _ComicCarouselItem() when $default != null:
return $default(_that);case _:
...
switch (_that) {
case _ComicCarouselItem():
return $default(_that.subText,_that.image,_that.comicId,_that.name,_that.originalName,_that.type,_that.episodeDuration,_that.updatedAt,_that.quality,_that.countSub,_that.countDub,_that.rate,_that.notice,_that.year,_that.description,_that.studio,_that.duration,_that.language,_that.genres,_that.actors);}
}
