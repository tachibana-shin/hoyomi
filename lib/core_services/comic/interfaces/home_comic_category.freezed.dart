...
mixin _$HomeComicCategory {
 ...
 String get name; String? get categoryId; bool? get gridView; List<Comic> get items;
...
abstract mixin class $HomeComicCategoryCopyWith<$Res>  {
  factory $HomeComicCategoryCopyWith(HomeComicCategory value, $Res Function(HomeComicCategory) _then) = _$HomeComicCategoryCopyWithImpl;
@useResult
$Res call({
...
/// Adds pattern-matching-related methods to [HomeComicCategory].
extension HomeComicCategoryPatterns on HomeComicCategory {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _HomeComicCategory value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _HomeComicCategory() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _HomeComicCategory value)  $default,){
final _that = this;
switch (_that) {
case _HomeComicCategory():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _HomeComicCategory value)?  $default,){
final _that = this;
switch (_that) {
case _HomeComicCategory() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String? categoryId,  bool? gridView,  List<Comic> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HomeComicCategory() when $default != null:
return $default(_that.name,_that.categoryId,_that.gridView,_that.items);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String? categoryId,  bool? gridView,  List<Comic> items)  $default,) {final _that = this;
switch (_that) {
case _HomeComicCategory():
return $default(_that.name,_that.categoryId,_that.gridView,_that.items);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String? categoryId,  bool? gridView,  List<Comic> items)?  $default,) {final _that = this;
switch (_that) {
case _HomeComicCategory() when $default != null:
return $default(_that.name,_that.categoryId,_that.gridView,_that.items);case _:
  return null;
...
/// @nodoc
abstract mixin class _$HomeComicCategoryCopyWith<$Res> implements $HomeComicCategoryCopyWith<$Res> {
  factory _$HomeComicCategoryCopyWith(_HomeComicCategory value, $Res Function(_HomeComicCategory) _then) = __$HomeComicCategoryCopyWithImpl;
@override @useResult
$Res call({
 String name, String? categoryId, bool? gridView, List<Comic> items
});
