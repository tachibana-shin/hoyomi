...
mixin _$ComicChapter {
 ...
 String get name; String? get fullName; String get chapterId; DateTime? get time; String? get extra; int get order;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,fullName,chapterId,time,extra,order);
...
@useResult
$Res call({
 String name, String? fullName, String chapterId, DateTime? time, String? extra, int order
});
...
/// Create a copy of ComicChapter
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? fullName = freezed,Object? chapterId = null,Object? time = freezed,Object? extra = freezed,Object? order = null,}) {
...
class _ComicChapter implements ComicChapter {
  const _ComicChapter({required this.name, this.fullName, required this.chapterId, this.time, this.extra, this.order = -1});
...
/// Create a copy of ComicChapter
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? fullName = freezed,Object? chapterId = null,Object? time = freezed,Object? extra = freezed,Object? order = null,}) {
