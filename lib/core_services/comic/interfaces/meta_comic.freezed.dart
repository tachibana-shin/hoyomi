...
mixin _$MetaComic {
 ...
 String get name; String? get originalName; OImage get image; String? get author; String? get translator; StatusEnum get status; int? get views; int? get likes; RateValue? get rate; List<Genre> get genres; String get description; List<ComicChapter> get chapters; DateTime get lastModified; bool get fake;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,originalName,image,author,translator,status,views,likes,rate,const DeepCollectionEquality().hash(genres),description,const DeepCollectionEquality().hash(chapters),lastModified,fake);
...
@useResult
$Res call({
 String name, String? originalName, OImage image, String? author, String? translator, StatusEnum status, int? views, int? likes, RateValue? rate, List<Genre> genres, String description, List<ComicChapter> chapters, DateTime lastModified, bool fake
});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,originalName,image,author,translator,status,views,likes,rate,const DeepCollectionEquality().hash(_genres),description,const DeepCollectionEquality().hash(_chapters),lastModified,fake);
