...
/// @nodoc
class _$ComicHistoryCopyWithImpl<$Res>
...
/// Adds pattern-matching-related methods to [ComicHistory].
extension ComicHistoryPatterns on ComicHistory {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ComicHistory value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ComicHistory() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ComicHistory value)  $default,){
final _that = this;
switch (_that) {
case _ComicHistory():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ComicHistory value)?  $default,){
final _that = this;
switch (_that) {
case _ComicHistory() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String sourceId,  Comic item,  DateTime watchUpdatedAt,  ComicChapter lastChapter,  WatchPage watchPage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ComicHistory() when $default != null:
return $default(_that.sourceId,_that.item,_that.watchUpdatedAt,_that.lastChapter,_that.watchPage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String sourceId,  Comic item,  DateTime watchUpdatedAt,  ComicChapter lastChapter,  WatchPage watchPage)  $default,) {final _that = this;
switch (_that) {
case _ComicHistory():
return $default(_that.sourceId,_that.item,_that.watchUpdatedAt,_that.lastChapter,_that.watchPage);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String sourceId,  Comic item,  DateTime watchUpdatedAt,  ComicChapter lastChapter,  WatchPage watchPage)?  $default,) {final _that = this;
switch (_that) {
case _ComicHistory() when $default != null:
return $default(_that.sourceId,_that.item,_that.watchUpdatedAt,_that.lastChapter,_that.watchPage);case _:
  return null;
...
/// @nodoc
abstract mixin class _$ComicHistoryCopyWith<$Res> implements $ComicHistoryCopyWith<$Res> {
