...
as List<Genre>?,movieSeason: freezed == movieSeason ? _self.movieSeason : movieSeason // ignore: cast_nullable_to_non_nullable
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,name,originalName,image,poster,description,rate,countRate,countSub,countDub,duration,yearOf,views,const DeepCollectionEquality().hash(_seasons),const DeepCollectionEquality().hash(_genres),quality,const DeepCollectionEquality().hash(_authors),const DeepCollectionEquality().hash(_countries),language,const DeepCollectionEquality().hash(_studios),movieSeason,trailer,fake]);
