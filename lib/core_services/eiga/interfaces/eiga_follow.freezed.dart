...
/// Adds pattern-matching-related methods to [EigaFollow].
extension EigaFollowPatterns on EigaFollow {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EigaFollow value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _EigaFollow() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EigaFollow value)  $default,){
final _that = this;
switch (_that) {
case _EigaFollow():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EigaFollow value)?  $default,){
final _that = this;
switch (_that) {
case _EigaFollow() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String sourceId,  Eiga item,  DateTime? updatedAt,  EigaEpisode? lastEpisode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EigaFollow() when $default != null:
return $default(_that.sourceId,_that.item,_that.updatedAt,_that.lastEpisode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String sourceId,  Eiga item,  DateTime? updatedAt,  EigaEpisode? lastEpisode)  $default,) {final _that = this;
switch (_that) {
case _EigaFollow():
return $default(_that.sourceId,_that.item,_that.updatedAt,_that.lastEpisode);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String sourceId,  Eiga item,  DateTime? updatedAt,  EigaEpisode? lastEpisode)?  $default,) {final _that = this;
switch (_that) {
case _EigaFollow() when $default != null:
return $default(_that.sourceId,_that.item,_that.updatedAt,_that.lastEpisode);case _:
  return null;
