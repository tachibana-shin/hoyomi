...
/// Adds pattern-matching-related methods to [HomeEigaCategory].
extension HomeEigaCategoryPatterns on HomeEigaCategory {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _HomeEigaCategory value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _HomeEigaCategory() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _HomeEigaCategory value)  $default,){
final _that = this;
switch (_that) {
case _HomeEigaCategory():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _HomeEigaCategory value)?  $default,){
final _that = this;
switch (_that) {
case _HomeEigaCategory() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String? categoryId,  bool gridView,  List<Eiga> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HomeEigaCategory() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String? categoryId,  bool gridView,  List<Eiga> items)  $default,) {final _that = this;
switch (_that) {
case _HomeEigaCategory():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String? categoryId,  bool gridView,  List<Eiga> items)?  $default,) {final _that = this;
switch (_that) {
case _HomeEigaCategory() when $default != null:
return $default(_that.name,_that.categoryId,_that.gridView,_that.items);case _:
  return null;
