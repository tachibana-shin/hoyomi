...
class NguonCService extends ABEigaService {
  ...
  getSuggest({required metaEiga, required eigaId, page}) async {
    return (await getCategory(
      categoryId: metaEiga.genres.first.genreId,
      page: 1,
      filters: {},
    )).items;
  }
...
class _Cat {
  ...
  _Cat({required this.name, required this.title, required this.slug});

  factory _Cat.fromJson(Map<String, dynamic> json) {
    return _Cat(name: json['name'], title: json['title'], slug: json['slug']);
  }

  Map<String, dynamic> toJson() {
    return {'name': name, 'title': title, 'slug': slug};
  }
}
...
class _MovieDetailResponse {
  ...
  _MovieDetailResponse({required this.status, required this.movie});
  ...
  Map<String, dynamic> toJson() {
    return {'status': status, 'movie': movie.toJson()};
  }
}
...
class _CategoryGroup {
  ...
  _CategoryGroup({required this.group, required this.list});
...
class _Group {
  ...
  _Group({required this.id, required this.name});

  factory _Group.fromJson(Map<String, dynamic> json) {
    return _Group(id: json['id'], name: json['name']);
  }
...
class _CategoryItem {
  ...
  factory _CategoryItem.fromJson(Map<String, dynamic> json) {
    return _CategoryItem(id: json['id'], name: json['name']);
  }
...
class _EpisodeGroup {
  ...
  _EpisodeGroup({required this.serverName, required this.items});
...
class _EpisodeItem {
  ...
  Map<String, dynamic> toJson() {
    return {'name': name, 'slug': slug, 'embed': embed, 'm3u8': m3u8};
  }
}
