...
mixin _$PropsGetSeekThumbnail {
  ...
  $PropsGetSeekThumbnailCopyWith<PropsGetSeekThumbnail> get copyWith =>
      _$PropsGetSeekThumbnailCopyWithImpl<PropsGetSeekThumbnail>(
          this as PropsGetSeekThumbnail, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PropsGetSeekThumbnail &&
...
abstract mixin class $PropsGetSeekThumbnailCopyWith<$Res> {
  factory $PropsGetSeekThumbnailCopyWith(PropsGetSeekThumbnail value,
          $Res Function(PropsGetSeekThumbnail) _then) =
      _$PropsGetSeekThumbnailCopyWithImpl;
  @useResult
  $Res call(
      {String eigaId,
      MetaEiga metaEiga,
...
class _PropsGetSeekThumbnail implements PropsGetSeekThumbnail {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PropsGetSeekThumbnailCopyWith<_PropsGetSeekThumbnail> get copyWith =>
      __$PropsGetSeekThumbnailCopyWithImpl<_PropsGetSeekThumbnail>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PropsGetSeekThumbnail &&
            (identical(other.eigaId, eigaId) || other.eigaId == eigaId) &&
            (identical(other.metaEiga, metaEiga) ||
                other.metaEiga == metaEiga) &&
            (identical(other.episode, episode) || other.episode == episode) &&
...
/// @nodoc
abstract mixin class _$PropsGetSeekThumbnailCopyWith<$Res>
    implements $PropsGetSeekThumbnailCopyWith<$Res> {
  factory _$PropsGetSeekThumbnailCopyWith(_PropsGetSeekThumbnail value,
          $Res Function(_PropsGetSeekThumbnail) _then) =
      __$PropsGetSeekThumbnailCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String eigaId,
...
mixin _$PropsGetOpeningEnding {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PropsGetOpeningEndingCopyWith<PropsGetOpeningEnding> get copyWith =>
      _$PropsGetOpeningEndingCopyWithImpl<PropsGetOpeningEnding>(
          this as PropsGetOpeningEnding, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PropsGetOpeningEnding &&
            (identical(other.eigaId, eigaId) || other.eigaId == eigaId) &&
            (identical(other.metaEiga, metaEiga) ||
                other.metaEiga == metaEiga) &&
            (identical(other.episode, episode) || other.episode == episode) &&
...
abstract mixin class $PropsGetOpeningEndingCopyWith<$Res> {
  factory $PropsGetOpeningEndingCopyWith(PropsGetOpeningEnding value,
          $Res Function(PropsGetOpeningEnding) _then) =
      _$PropsGetOpeningEndingCopyWithImpl;
  @useResult
  $Res call(
      {String eigaId,
      MetaEiga metaEiga,
...
class _PropsGetOpeningEnding implements PropsGetOpeningEnding {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PropsGetOpeningEndingCopyWith<_PropsGetOpeningEnding> get copyWith =>
      __$PropsGetOpeningEndingCopyWithImpl<_PropsGetOpeningEnding>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PropsGetOpeningEnding &&
            (identical(other.eigaId, eigaId) || other.eigaId == eigaId) &&
            (identical(other.metaEiga, metaEiga) ||
                other.metaEiga == metaEiga) &&
            (identical(other.episode, episode) || other.episode == episode) &&
...
/// @nodoc
abstract mixin class _$PropsGetOpeningEndingCopyWith<$Res>
    implements $PropsGetOpeningEndingCopyWith<$Res> {
  factory _$PropsGetOpeningEndingCopyWith(_PropsGetOpeningEnding value,
          $Res Function(_PropsGetOpeningEnding) _then) =
      __$PropsGetOpeningEndingCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String eigaId,
