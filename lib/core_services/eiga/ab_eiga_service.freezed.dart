...
/// Adds pattern-matching-related methods to [EigaSourceContext].
extension EigaSourceContextPatterns on EigaSourceContext {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EigaSourceContext value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _EigaSourceContext() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EigaSourceContext value)  $default,){
final _that = this;
switch (_that) {
case _EigaSourceContext():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EigaSourceContext value)?  $default,){
final _that = this;
switch (_that) {
case _EigaSourceContext() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String eigaId,  MetaEiga metaEiga,  EigaEpisode episode,  SourceVideo source)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EigaSourceContext() when $default != null:
return $default(_that.eigaId,_that.metaEiga,_that.episode,_that.source);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String eigaId,  MetaEiga metaEiga,  EigaEpisode episode,  SourceVideo source)  $default,) {final _that = this;
switch (_that) {
case _EigaSourceContext():
return $default(_that.eigaId,_that.metaEiga,_that.episode,_that.source);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String eigaId,  MetaEiga metaEiga,  EigaEpisode episode,  SourceVideo source)?  $default,) {final _that = this;
switch (_that) {
case _EigaSourceContext() when $default != null:
return $default(_that.eigaId,_that.metaEiga,_that.episode,_that.source);case _:
  return null;
