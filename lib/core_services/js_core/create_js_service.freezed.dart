...
/// Adds pattern-matching-related methods to [JsServiceMeta].
extension JsServiceMetaPatterns on JsServiceMeta {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _JsServiceMeta value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _JsServiceMeta() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _JsServiceMeta value)  $default,){
final _that = this;
switch (_that) {
case _JsServiceMeta():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _JsServiceMeta value)?  $default,){
final _that = this;
switch (_that) {
case _JsServiceMeta() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String type,  ServiceInit init, @JsonKey(name: '\$isAuth')  bool isAuth,  String? writeWith)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JsServiceMeta() when $default != null:
return $default(_that.type,_that.init,_that.isAuth,_that.writeWith);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String type,  ServiceInit init, @JsonKey(name: '\$isAuth')  bool isAuth,  String? writeWith)  $default,) {final _that = this;
switch (_that) {
case _JsServiceMeta():
return $default(_that.type,_that.init,_that.isAuth,_that.writeWith);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String type,  ServiceInit init, @JsonKey(name: '\$isAuth')  bool isAuth,  String? writeWith)?  $default,) {final _that = this;
switch (_that) {
case _JsServiceMeta() when $default != null:
return $default(_that.type,_that.init,_that.isAuth,_that.writeWith);case _:
  return null;
