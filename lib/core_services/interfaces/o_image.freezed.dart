...
/// Adds pattern-matching-related methods to [OImage].
extension OImagePatterns on OImage {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _OImage value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _OImage() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _OImage value)  $default,){
final _that = this;
switch (_that) {
case _OImage():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _OImage value)?  $default,){
final _that = this;
switch (_that) {
case _OImage() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String src,  Headers? headers,  String? extra)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OImage() when $default != null:
return $default(_that.src,_that.headers,_that.extra);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String src,  Headers? headers,  String? extra)  $default,) {final _that = this;
switch (_that) {
case _OImage():
return $default(_that.src,_that.headers,_that.extra);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String src,  Headers? headers,  String? extra)?  $default,) {final _that = this;
switch (_that) {
case _OImage() when $default != null:
return $default(_that.src,_that.headers,_that.extra);case _:
  return null;
