...
mixin _$ServiceInit {
 ...
 String get name; String? get uid; OImage get faviconUrl; String get rootUrl; String? get version; String? get description;/// Code language support
 String? get language; List<SettingField>? get settings; List<WebRule>? get webRules; bool get fetchHeadless; String? get fetchBaseUrl;///
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ServiceInit&&(identical(other.name, name) || other.name == name)&&(identical(other.uid, uid) || other.uid == uid)&&(identical(other.faviconUrl, faviconUrl) || other.faviconUrl == faviconUrl)&&(identical(other.rootUrl, rootUrl) || other.rootUrl == rootUrl)&&(identical(other.version, version) || other.version == version)&&(identical(other.description, description) || other.description == description)&&(identical(other.language, language) || other.language == language)&&const DeepCollectionEquality().equals(other.settings, settings)&&const DeepCollectionEquality().equals(other.webRules, webRules)&&(identical(other.fetchHeadless, fetchHeadless) || other.fetchHeadless == fetchHeadless)&&(identical(other.fetchBaseUrl, fetchBaseUrl) || other.fetchBaseUrl == fetchBaseUrl)&&(identical(other.captchaUrl, captchaUrl) || other.captchaUrl == captchaUrl)&&(identical(other.customCookie, customCookie) || other.customCookie == customCookie));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,uid,faviconUrl,rootUrl,version,description,language,const DeepCollectionEquality().hash(settings),const DeepCollectionEquality().hash(webRules),fetchHeadless,fetchBaseUrl,captchaUrl,customCookie);

@override
String toString() {
  return 'ServiceInit(name: $name, uid: $uid, faviconUrl: $faviconUrl, rootUrl: $rootUrl, version: $version, description: $description, language: $language, settings: $settings, webRules: $webRules, fetchHeadless: $fetchHeadless, fetchBaseUrl: $fetchBaseUrl, captchaUrl: $captchaUrl, customCookie: $customCookie)';
}
...
@useResult
$Res call({
 String name, String? uid, OImage faviconUrl, String rootUrl, String? version, String? description, String? language, List<SettingField>? settings, List<WebRule>? webRules, bool fetchHeadless, String? fetchBaseUrl, String? captchaUrl, String? customCookie
});
...
/// Adds pattern-matching-related methods to [ServiceInit].
extension ServiceInitPatterns on ServiceInit {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ServiceInit value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ServiceInit() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ServiceInit value)  $default,){
final _that = this;
switch (_that) {
case _ServiceInit():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ServiceInit value)?  $default,){
final _that = this;
switch (_that) {
case _ServiceInit() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String? uid,  OImage faviconUrl,  String rootUrl,  String? version,  String? description,  String? language,  List<SettingField>? settings,  List<WebRule>? webRules,  bool fetchHeadless,  String? fetchBaseUrl,  String? captchaUrl,  String? customCookie)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ServiceInit() when $default != null:
return $default(_that.name,_that.uid,_that.faviconUrl,_that.rootUrl,_that.version,_that.description,_that.language,_that.settings,_that.webRules,_that.fetchHeadless,_that.fetchBaseUrl,_that.captchaUrl,_that.customCookie);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String? uid,  OImage faviconUrl,  String rootUrl,  String? version,  String? description,  String? language,  List<SettingField>? settings,  List<WebRule>? webRules,  bool fetchHeadless,  String? fetchBaseUrl,  String? captchaUrl,  String? customCookie)  $default,) {final _that = this;
switch (_that) {
case _ServiceInit():
return $default(_that.name,_that.uid,_that.faviconUrl,_that.rootUrl,_that.version,_that.description,_that.language,_that.settings,_that.webRules,_that.fetchHeadless,_that.fetchBaseUrl,_that.captchaUrl,_that.customCookie);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String? uid,  OImage faviconUrl,  String rootUrl,  String? version,  String? description,  String? language,  List<SettingField>? settings,  List<WebRule>? webRules,  bool fetchHeadless,  String? fetchBaseUrl,  String? captchaUrl,  String? customCookie)?  $default,) {final _that = this;
switch (_that) {
case _ServiceInit() when $default != null:
return $default(_that.name,_that.uid,_that.faviconUrl,_that.rootUrl,_that.version,_that.description,_that.language,_that.settings,_that.webRules,_that.fetchHeadless,_that.fetchBaseUrl,_that.captchaUrl,_that.customCookie);case _:
  return null;
...
class _ServiceInit implements ServiceInit {
  const _ServiceInit({required this.name, this.uid, required this.faviconUrl, required this.rootUrl, this.version, this.description, this.language, final  List<SettingField>? settings, final  List<WebRule>? webRules, this.fetchHeadless = false, this.fetchBaseUrl, this.captchaUrl, this.customCookie}): _settings = settings,_webRules = webRules;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ServiceInit&&(identical(other.name, name) || other.name == name)&&(identical(other.uid, uid) || other.uid == uid)&&(identical(other.faviconUrl, faviconUrl) || other.faviconUrl == faviconUrl)&&(identical(other.rootUrl, rootUrl) || other.rootUrl == rootUrl)&&(identical(other.version, version) || other.version == version)&&(identical(other.description, description) || other.description == description)&&(identical(other.language, language) || other.language == language)&&const DeepCollectionEquality().equals(other._settings, _settings)&&const DeepCollectionEquality().equals(other._webRules, _webRules)&&(identical(other.fetchHeadless, fetchHeadless) || other.fetchHeadless == fetchHeadless)&&(identical(other.fetchBaseUrl, fetchBaseUrl) || other.fetchBaseUrl == fetchBaseUrl)&&(identical(other.captchaUrl, captchaUrl) || other.captchaUrl == captchaUrl)&&(identical(other.customCookie, customCookie) || other.customCookie == customCookie));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,uid,faviconUrl,rootUrl,version,description,language,const DeepCollectionEquality().hash(_settings),const DeepCollectionEquality().hash(_webRules),fetchHeadless,fetchBaseUrl,captchaUrl,customCookie);
