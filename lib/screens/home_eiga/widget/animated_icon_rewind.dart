...
class AnimatedIconRewind extends StatefulWidget {
  const AnimatedIconRewind({super.key});

  @override
  State<AnimatedIconRewind> createState() => _AnimatedIconRewindState();
}

class _AnimatedIconRewindState extends State<AnimatedIconRewind>
