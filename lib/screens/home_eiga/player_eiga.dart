...
class _PlayerEigaState extends State<PlayerEiga>
  ...
  void _onVerticalDragStartPlayer(DragStartDetails details) {
    ...
    final double screenHeight = _fullscreen.value
        ? 100.h(context)
        : min(
            100.h(context),
    ...
    if (details.primaryDelta != null) {
      if (isLeftSide) {
        ...
        _appBrightness.value =
            (_appBrightness.value - details.primaryDelta! / 100).clamp(
              0.0,
              1.0,
            );
          ...
          children: [
            ...
            Row(
              children: [
                ...
                // icon subtitle
                Watch(() {
                  final isEnabled = usePick(
                    () => _subtitles.value?.isNotEmpty == true,
                  ).value;
                  return Disabled(
                    disabled: !isEnabled,
                    child: IconButton(
        ...
        return Watch(
          () => ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                leading: _playbackRate.value == item.value
                    ? Icon(Icons.check)
                    : Text(''),
