...
class _HtmlSubtitleWrapperState extends State<HtmlSubtitleWrapper>
  ...
  late StreamSubscription<Duration> _cancelListenUpdatePosition;
  ...
  void initState() {
    ...
    _cancelListenUpdatePosition = widget.videoController.player.stream.position
  ...
  void didUpdateWidget(oldWidget) {
    ...
    if (oldWidget.videoController != widget.videoController) {
      _cancelListenUpdatePosition.cancel();
      _cancelListenUpdatePosition = widget
          .videoController
          .player
          .stream
          .position
