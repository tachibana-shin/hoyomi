...
class _CategoryComicPageState extends State<CategoryComicPage> with KaeruMixin {
  ...
  Widget build(BuildContext context) {
    return PullRefreshPage(
      ...
      builderError: (body) =>
          Watch(() => Scaffold(appBar: _buildAppBar(() async {}), body: body)),
      builder: (data, param) => Watch(
        () => Scaffold(
          ...
          : PreferredSize(
              ...
              child: Padding(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: _filters.value!.map((filter) {
                          ...
                          onTap: () {
                            DropDownState(
                              dropDown: DropDown(
                                ...
                                listItemBuilder: (index, selected) =>
