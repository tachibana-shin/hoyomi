                ...
                return FutureBuilder(
                  ...
                  builder: (context, snapshot) => snapshot.when(
                    data: (allDownloader, _) {
                      return Column(
                        children: allDownloader.map((downloader) {
                          ...
                          final main = Container(
                            ...
                            child: Padding(
                              ...
                              child: Watch(() {
                                return Column(
                                  children: comic.chapters.sortAsc
                                      .where(
                                        (chapter) => downloader.chapters
                                            .containsKey(chapter.chapterId),
                                      )
                                      .map((chapter) {
                                        ...
                                        final totalByteSize = download.pages
                                            .fold(
                                              0,
                                        ...
                                        return Row(
                                          children: [
                                            ...
                                            if (download.progress != null
                                                ? !download.progress!.value.done
                                                : download.doneAt <= 0) ...[
                                              Text(
                                                '${(progress * 100).round()}',
                                              ).paddingOnly(left: 2.0),
                                              if (download.progress == null)
                                                IconButton(
                          ...
                          return InkWell(
                            ...
                            child: Column(
                              children: [header, 10.0.heightBox, main],
