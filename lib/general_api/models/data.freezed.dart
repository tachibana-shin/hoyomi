...
@JsonKey(name: 'comic_text_id') String get comicTextId;/// The name of the watch history item (e.g., the episode title).
 ...
 String get poster;/// The name of the season the episode belongs to.
@JsonKey(name: 'season_name') String get seasonName;/// The source ID associated with the episode.
...
@JsonKey(name: 'watch_updated_at') String get watchUpdatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,createdAt,comicTextId,name,poster,seasonName,sourceId,watchCur,watchDur,watchId,watchName,watchUpdatedAt);
...
@useResult
$Res call({
@JsonKey(name: 'created_at') String createdAt,@JsonKey(name: 'comic_text_id') String comicTextId, String name, String poster,@JsonKey(name: 'season_name') String seasonName,@JsonKey(name: 'source_id') String sourceId,@JsonKey(name: 'watch_cur') num watchCur,@JsonKey(name: 'watch_dur') num watchDur,@JsonKey(name: 'watch_id') String watchId,@JsonKey(name: 'watch_name') String watchName,@JsonKey(name: 'watch_updated_at') String watchUpdatedAt
});
...
/// Create a copy of Data
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = null,Object? comicTextId = null,Object? name = null,Object? poster = null,Object? seasonName = null,Object? sourceId = null,Object? watchCur = null,Object? watchDur = null,Object? watchId = null,Object? watchName = null,Object? watchUpdatedAt = null,}) {
...
class _Data implements Data {
  const _Data({@JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'comic_text_id') required this.comicTextId, required this.name, required this.poster, @JsonKey(name: 'season_name') required this.seasonName, @JsonKey(name: 'source_id') required this.sourceId, @JsonKey(name: 'watch_cur') required this.watchCur, @JsonKey(name: 'watch_dur') required this.watchDur, @JsonKey(name: 'watch_id') required this.watchId, @JsonKey(name: 'watch_name') required this.watchName, @JsonKey(name: 'watch_updated_at') required this.watchUpdatedAt});
...
/// Create a copy of Data
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? createdAt = null,Object? comicTextId = null,Object? name = null,Object? poster = null,Object? seasonName = null,Object? sourceId = null,Object? watchCur = null,Object? watchDur = null,Object? watchId = null,Object? watchName = null,Object? watchUpdatedAt = null,}) {
  return _then(_Data(
createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as String,comicTextId: null == comicTextId ? _self.comicTextId : comicTextId // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
