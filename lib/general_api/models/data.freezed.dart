...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,createdAt,comicTextId,name,originalName,poster,sourceId,watchCur,watchDur,watchId,watchName,watchUpdatedAt,seasonName);

@override
String toString() {
  return 'Data(createdAt: $createdAt, comicTextId: $comicTextId, name: $name, originalName: $originalName, poster: $poster, sourceId: $sourceId, watchCur: $watchCur, watchDur: $watchDur, watchId: $watchId, watchName: $watchName, watchUpdatedAt: $watchUpdatedAt, seasonName: $seasonName)';
}
...
@useResult
$Res call({
@JsonKey(name: 'created_at') String createdAt,@JsonKey(name: 'comic_text_id') String comicTextId, String name,@JsonKey(name: 'original_name') String originalName, String poster,@JsonKey(name: 'source_id') String sourceId,@JsonKey(name: 'watch_cur') num watchCur,@JsonKey(name: 'watch_dur') num watchDur,@JsonKey(name: 'watch_id') String watchId,@JsonKey(name: 'watch_name') String watchName,@JsonKey(name: 'watch_updated_at') String watchUpdatedAt,@JsonKey(name: 'season_name') String seasonName
});
...
/// Create a copy of Data
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = null,Object? comicTextId = null,Object? name = null,Object? originalName = null,Object? poster = null,Object? sourceId = null,Object? watchCur = null,Object? watchDur = null,Object? watchId = null,Object? watchName = null,Object? watchUpdatedAt = null,Object? seasonName = null,}) {
...
class _Data implements Data {
  const _Data({@JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'comic_text_id') required this.comicTextId, required this.name, @JsonKey(name: 'original_name') required this.originalName, required this.poster, @JsonKey(name: 'source_id') required this.sourceId, @JsonKey(name: 'watch_cur') required this.watchCur, @JsonKey(name: 'watch_dur') required this.watchDur, @JsonKey(name: 'watch_id') required this.watchId, @JsonKey(name: 'watch_name') required this.watchName, @JsonKey(name: 'watch_updated_at') required this.watchUpdatedAt, @JsonKey(name: 'season_name') this.seasonName = ''});
