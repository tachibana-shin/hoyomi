...
/// The current page in seconds for the episode.
 ...
 String get name;/// ISO 8601 format pagestamp when the watch page was recorded.
 String get createdAt;/// ISO 8601 format pagestamp when the watch page was last updated.
...
class _Data3 implements Data3 {
  const _Data3({required this.cur, required this.dur, required this.name, required this.createdAt, required this.updatedAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Data3&&(identical(other.cur, cur) || other.cur == cur)&&(identical(other.dur, dur) || other.dur == dur)&&(identical(other.name, name) || other.name == name)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}
