...
@JsonKey(name: 'created_at') String get createdAt;@JsonKey(name: 'comic_text_id') String get comicTextId; String get name; String get poster;@JsonKey(name: 'season_name') String? get seasonName;@JsonKey(name: 'source_id') String get sourceId;@JsonKey(name: 'chapter_name') String get chapterName;@JsonKey(name: 'chapter_id') String get chapterId;@JsonKey(name: 'chapter_time') String? get chapterTime;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,createdAt,comicTextId,name,poster,seasonName,sourceId,chapterName,chapterId,chapterTime);

@override
String toString() {
  return 'Items(createdAt: $createdAt, comicTextId: $comicTextId, name: $name, poster: $poster, seasonName: $seasonName, sourceId: $sourceId, chapterName: $chapterName, chapterId: $chapterId, chapterTime: $chapterTime)';
}
...
@useResult
$Res call({
@JsonKey(name: 'created_at') String createdAt,@JsonKey(name: 'comic_text_id') String comicTextId, String name, String poster,@JsonKey(name: 'season_name') String? seasonName,@JsonKey(name: 'source_id') String sourceId,@JsonKey(name: 'chapter_name') String chapterName,@JsonKey(name: 'chapter_id') String chapterId,@JsonKey(name: 'chapter_time') String? chapterTime
});
...
/// Create a copy of Items
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = null,Object? comicTextId = null,Object? name = null,Object? poster = null,Object? seasonName = freezed,Object? sourceId = null,Object? chapterName = null,Object? chapterId = null,Object? chapterTime = freezed,}) {
...
class _Items implements Items {
  const _Items({@JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'comic_text_id') required this.comicTextId, required this.name, required this.poster, @JsonKey(name: 'season_name') required this.seasonName, @JsonKey(name: 'source_id') required this.sourceId, @JsonKey(name: 'chapter_name') required this.chapterName, @JsonKey(name: 'chapter_id') required this.chapterId, @JsonKey(name: 'chapter_time') required this.chapterTime});
...
/// Create a copy of Items
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? createdAt = null,Object? comicTextId = null,Object? name = null,Object? poster = null,Object? seasonName = freezed,Object? sourceId = null,Object? chapterName = null,Object? chapterId = null,Object? chapterTime = freezed,}) {
  return _then(_Items(
createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as String,comicTextId: null == comicTextId ? _self.comicTextId : comicTextId // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
