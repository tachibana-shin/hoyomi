...
const BookSchema = CollectionSchema(
  ...
  links: {
    r'histories': LinkSchema(
      id: 3580017145243168422,
      name: r'histories',
      target: r'HistoryChap',
      single: false,
      linkName: r'book',
    )
  },
...
void _bookAttach(IsarCollection<dynamic> col, Id id, Book object) {
  object.id = id;
  object.histories
      .attach(col, col.isar.collection<HistoryChap>(), r'histories', id);
}
...
extension BookQueryLinks on QueryBuilder<Book, Book, QFilterCondition> {
  QueryBuilder<Book, Book, QAfterFilterCondition> histories(
      FilterQuery<HistoryChap> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'histories');
    });
  }

  QueryBuilder<Book, Book, QAfterFilterCondition> historiesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'histories', length, true, length, true);
    });
  }

  QueryBuilder<Book, Book, QAfterFilterCondition> historiesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'histories', 0, true, 0, true);
    });
  }

  QueryBuilder<Book, Book, QAfterFilterCondition> historiesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'histories', 0, false, 999999, true);
    });
  }

  QueryBuilder<Book, Book, QAfterFilterCondition> historiesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'histories', 0, true, length, include);
    });
  }

  QueryBuilder<Book, Book, QAfterFilterCondition> historiesLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'histories', length, include, 999999, true);
    });
  }

  QueryBuilder<Book, Book, QAfterFilterCondition> historiesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'histories', lower, includeLower, upper, includeUpper);
    });
  }
}
