...
mixin _$ComicCarouselItem {
  ...
  $ComicCarouselItemCopyWith<ComicCarouselItem> get copyWith =>
      _$ComicCarouselItemCopyWithImpl<ComicCarouselItem>(
          this as ComicCarouselItem, _$identity);
...
abstract mixin class $ComicCarouselItemCopyWith<$Res> {
  factory $ComicCarouselItemCopyWith(
          ComicCarouselItem value, $Res Function(ComicCarouselItem) _then) =
      _$ComicCarouselItemCopyWithImpl;
  @useResult
  $Res call(
      {String? subText,
      OImage image,
...
class _ComicCarouselItem implements ComicCarouselItem {
  const _ComicCarouselItem(
      ...
      : _genres = genres,
        _actors = actors;
  factory _ComicCarouselItem.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ComicCarouselItemCopyWith<_ComicCarouselItem> get copyWith =>
      __$ComicCarouselItemCopyWithImpl<_ComicCarouselItem>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ComicCarouselItemToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ComicCarouselItemCopyWith<$Res>
    implements $ComicCarouselItemCopyWith<$Res> {
  factory _$ComicCarouselItemCopyWith(
          _ComicCarouselItem value, $Res Function(_ComicCarouselItem) _then) =
      __$ComicCarouselItemCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? subText,
