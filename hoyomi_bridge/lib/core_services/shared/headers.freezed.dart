...
mixin _$Headers {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(headers));
...
abstract mixin class $HeadersCopyWith<$Res> {
  ...
  @useResult
  $Res call({Map<String, List<String>> headers});
}
...
class _Headers implements Headers {
  const _Headers({final Map<String, List<String>> headers = const {}})
      : _headers = headers;
