...
mixin _$EigaEpisodes {
  ...
  $EigaEpisodesCopyWith<EigaEpisodes> get copyWith =>
      _$EigaEpisodesCopyWithImpl<EigaEpisodes>(
          this as EigaEpisodes, _$identity);
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(episodes), image, poster, schedule);
...
abstract mixin class $EigaEpisodesCopyWith<$Res> {
  factory $EigaEpisodesCopyWith(
          EigaEpisodes value, $Res Function(EigaEpisodes) _then) =
      _$EigaEpisodesCopyWithImpl;
  @useResult
  $Res call(
...
/// @nodoc
class _$EigaEpisodesCopyWithImpl<$Res> implements $EigaEpisodesCopyWith<$Res> {
...
class _EigaEpisodes implements EigaEpisodes {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EigaEpisodesCopyWith<_EigaEpisodes> get copyWith =>
      __$EigaEpisodesCopyWithImpl<_EigaEpisodes>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$EigaEpisodesToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$EigaEpisodesCopyWith<$Res>
    implements $EigaEpisodesCopyWith<$Res> {
  factory _$EigaEpisodesCopyWith(
          _EigaEpisodes value, $Res Function(_EigaEpisodes) _then) =
      __$EigaEpisodesCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<EigaEpisode> episodes,
