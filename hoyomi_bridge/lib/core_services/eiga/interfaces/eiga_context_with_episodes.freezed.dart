...
mixin _$EigaContextWithEpisodes {
  ...
  $EigaContextWithEpisodesCopyWith<EigaContextWithEpisodes> get copyWith =>
      _$EigaContextWithEpisodesCopyWithImpl<EigaContextWithEpisodes>(
          this as EigaContextWithEpisodes, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is EigaContextWithEpisodes &&
  ...
  @override
  int get hashCode => Object.hash(runtimeType, eigaId, metaEiga, season,
...
abstract mixin class $EigaContextWithEpisodesCopyWith<$Res> {
  factory $EigaContextWithEpisodesCopyWith(EigaContextWithEpisodes value,
          $Res Function(EigaContextWithEpisodes) _then) =
      _$EigaContextWithEpisodesCopyWithImpl;
  @useResult
  $Res call(
      {String eigaId,
      MetaEiga metaEiga,
...
class _EigaContextWithEpisodes implements EigaContextWithEpisodes {
  const _EigaContextWithEpisodes(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EigaContextWithEpisodesCopyWith<_EigaContextWithEpisodes> get copyWith =>
      __$EigaContextWithEpisodesCopyWithImpl<_EigaContextWithEpisodes>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _EigaContextWithEpisodes &&
            (identical(other.eigaId, eigaId) || other.eigaId == eigaId) &&
            (identical(other.metaEiga, metaEiga) ||
                other.metaEiga == metaEiga) &&
            (identical(other.season, season) || other.season == season) &&
...
/// @nodoc
abstract mixin class _$EigaContextWithEpisodesCopyWith<$Res>
    implements $EigaContextWithEpisodesCopyWith<$Res> {
  factory _$EigaContextWithEpisodesCopyWith(_EigaContextWithEpisodes value,
          $Res Function(_EigaContextWithEpisodes) _then) =
      __$EigaContextWithEpisodesCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String eigaId,
