...
mixin _$EigaContext {
  ...
  $EigaContextCopyWith<EigaContext> get copyWith =>
      _$EigaContextCopyWithImpl<EigaContext>(this as EigaContext, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is EigaContext &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, eigaId, metaEiga, episode, season);
...
abstract mixin class $EigaContextCopyWith<$Res> {
  factory $EigaContextCopyWith(
          EigaContext value, $Res Function(EigaContext) _then) =
      _$EigaContextCopyWithImpl;
  @useResult
  $Res call(
...
/// @nodoc
class _$EigaContextCopyWithImpl<$Res> implements $EigaContextCopyWith<$Res> {
...
class _EigaContext implements EigaContext {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EigaContextCopyWith<_EigaContext> get copyWith =>
      __$EigaContextCopyWithImpl<_EigaContext>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _EigaContext &&
            (identical(other.eigaId, eigaId) || other.eigaId == eigaId) &&
            (identical(other.metaEiga, metaEiga) ||
                other.metaEiga == metaEiga) &&
            (identical(other.episode, episode) || other.episode == episode) &&
...
/// @nodoc
abstract mixin class _$EigaContextCopyWith<$Res>
    implements $EigaContextCopyWith<$Res> {
  factory _$EigaContextCopyWith(
          _EigaContext value, $Res Function(_EigaContext) _then) =
      __$EigaContextCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String eigaId, MetaEiga metaEiga, EigaEpisode episode, Season? season});
...
/// @nodoc
class __$EigaContextCopyWithImpl<$Res> implements _$EigaContextCopyWith<$Res> {
