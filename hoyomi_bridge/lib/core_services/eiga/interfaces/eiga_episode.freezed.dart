...
mixin _$EigaEpisode {
  ...
  $EigaEpisodeCopyWith<EigaEpisode> get copyWith =>
      _$EigaEpisodeCopyWithImpl<EigaEpisode>(this as EigaEpisode, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, name, episodeId, image, description, extra, order);
...
abstract mixin class $EigaEpisodeCopyWith<$Res> {
  factory $EigaEpisodeCopyWith(
          EigaEpisode value, $Res Function(EigaEpisode) _then) =
      _$EigaEpisodeCopyWithImpl;
  @useResult
  $Res call(
      {String name,
      String episodeId,
...
/// @nodoc
class _$EigaEpisodeCopyWithImpl<$Res> implements $EigaEpisodeCopyWith<$Res> {
...
class _EigaEpisode implements EigaEpisode {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EigaEpisodeCopyWith<_EigaEpisode> get copyWith =>
      __$EigaEpisodeCopyWithImpl<_EigaEpisode>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$EigaEpisodeToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$EigaEpisodeCopyWith<$Res>
    implements $EigaEpisodeCopyWith<$Res> {
  factory _$EigaEpisodeCopyWith(
          _EigaEpisode value, $Res Function(_EigaEpisode) _then) =
      __$EigaEpisodeCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String name,
...
/// @nodoc
class __$EigaEpisodeCopyWithImpl<$Res> implements _$EigaEpisodeCopyWith<$Res> {
