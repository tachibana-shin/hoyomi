...
mixin _$EigaCarousel {
  List<EigaCarouselItem> get items;
  ...
  $EigaCarouselCopyWith<EigaCarousel> get copyWith =>
      _$EigaCarouselCopyWithImpl<EigaCarousel>(
          this as EigaCarousel, _$identity);
...
abstract mixin class $EigaCarouselCopyWith<$Res> {
  factory $EigaCarouselCopyWith(
          EigaCarousel value, $Res Function(EigaCarousel) _then) =
      _$EigaCarouselCopyWithImpl;
  @useResult
  $Res call(
      {List<EigaCarouselItem> items,
      double aspectRatio,
      double maxHeightBuilder});
}

/// @nodoc
class _$EigaCarouselCopyWithImpl<$Res> implements $EigaCarouselCopyWith<$Res> {
...
class _EigaCarousel implements EigaCarousel {
  const _EigaCarousel(
      {required final List<EigaCarouselItem> items,
      required this.aspectRatio,
      required this.maxHeightBuilder})
      : _items = items;
  factory _EigaCarousel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EigaCarouselCopyWith<_EigaCarousel> get copyWith =>
      __$EigaCarouselCopyWithImpl<_EigaCarousel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$EigaCarouselToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$EigaCarouselCopyWith<$Res>
    implements $EigaCarouselCopyWith<$Res> {
  factory _$EigaCarouselCopyWith(
          _EigaCarousel value, $Res Function(_EigaCarousel) _then) =
      __$EigaCarouselCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<EigaCarouselItem> items,
